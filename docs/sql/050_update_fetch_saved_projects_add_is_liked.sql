-- =====================================================
-- v1_fetch_saved_projects 함수에 is_liked 필드 추가
-- =====================================================
-- 
-- 저장한 프로젝트 조회 함수에 현재 사용자의 좋아요 상태를 추가합니다.
-- 
-- 실행 방법:
--   psql "postgresql://postgres.xyqpggpilgcdsawuvpzn:ZNDqDunnaydr0aFQ@aws-0-ap-northeast-2.pooler.supabase.com:5432/postgres" -f docs/sql/050_update_fetch_saved_projects_add_is_liked.sql
-- 
-- =====================================================
-- 1. v1_fetch_saved_projects 함수 업데이트
-- =====================================================
 ...
 * 
 * 반환값:
 *   - 저장한 프로젝트 목록 (작성자 정보, 저장 일시, 내가 생성한 프로젝트 여부, 좋아요 상태 포함)
 * 
 * 보안:
...
COMMENT ON FUNCTION odd.v1_fetch_saved_projects IS '현재 사용자가 저장한 프로젝트 목록을 조회하는 함수. 내가 생성한 프로젝트와 저장한 프로젝트를 구분하여 반환하며, 현재 사용자의 좋아요 상태도 포함합니다.';
