    ...
    <div className="min-h-screen bg-white dark:bg-surface-950">
      <div className="mx-auto max-w-5xl px-4 py-6 md:py-12">
        ...
        <div className={cn(
          ...
          {step === "email" ? (
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white dark:bg-black text-surface-500 dark:text-surface-500">
                  또는
                </span>
              </div>
            </div>
          ...
          <>
              <h1 className="text-[31px] font-bold leading-9 text-surface-900 dark:text-white mb-6 text-center">
                계정 만들기
              </h1>
              ...
              <button
                ...
                className="mt-6 text-[15px] text-primary-600 dark:text-primary-400 hover:underline w-full text-center"
              >
                ← 이메일 변경
              </button>
            </>
